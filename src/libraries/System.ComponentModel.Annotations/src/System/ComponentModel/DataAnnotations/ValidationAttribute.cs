...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public abstract class ValidationAttribute : Attribute
    {
        ...
        private void SetResourceAccessorByPropertyLookup()
        {
            ...
            // TODO: If the user-provided provided returns null, an ArgumentNullException is thrown - should probably throw a better exception
        ...
        public virtual bool IsValid(object? value)
        {
            ...
            // TODO: The null here seems to be a bug - current sub-types overriding IsValid(value, validationContext) require a value here,
            // and throw NRE. This entry point is probably never used - Validator goes through GetValidationResult which always passes
            // a non-null ValidationContext
